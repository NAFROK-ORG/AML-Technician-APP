...
/* ─── Stepper ───────────────────────────────────────────────────────────────
   Full-width row: [−] [value display] [+]
   Large tap targets (48 px buttons) for mobile comfort.
   step=100 for money fields, step=1 for time/day fields.
─────────────────────────────────────────────────────────────────────────── */
function Stepper({ label, name, register, setValue, watch, required = true, step = 1, prefix = "" }) {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
      ...
      <div style={{
        ...
        <button
          ...
          onTouchStart={e => { if (val > 0) e.currentTarget.style.background = "#1C1C24"; }}
          onTouchEnd={e => { e.currentTarget.style.background = "transparent"; }}
        >
          −
        </button>

        {/* Value display (hidden real input keeps react-hook-form happy) */}
        <div style={{
          flex: 1,
          display: "flex",
          alignItems: "center",
        ...
        <button
          ...
          onTouchStart={e => { e.currentTarget.style.background = "#1C1C24"; }}
          onTouchEnd={e => { e.currentTarget.style.background = "transparent"; }}
        >
          +
        </button>
    ...
    >
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <button
              ...
              onTouchStart={e => { e.currentTarget.style.borderColor = "#3F3F46"; }}
              onTouchEnd={e => { e.currentTarget.style.borderColor = "#27272A"; }}
            >
              ×
            </button>
          </div>
        ...
        >
          ...
          {/* ── Steppers (order: Labour → Leave Days → Hours Worked → Incentive) ── */}
          <Stepper
            label="Labour Amount"
            name="labourAmount"
            register={register}
