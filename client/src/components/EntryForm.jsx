...
// FIX: was new Date().toISOString().split("T")[0] which returns UTC date.
// In IST (UTC+5:30) after 11 PM, that returns tomorrow's date.
// This returns the correct local calendar date every time.
...
const GLOBAL_STYLES = `
  ...
  .ef-submit:hover:not(:disabled) { background: #1E40AF !important; }
  .ef-submit:active:not(:disabled) { background: #1E3A8A !important; transform: scale(0.99); }
  .ef-submit:disabled { background: #93C5FD !important; cursor: not-allowed; }
...
const ProgressBar = ({ visible }) => (
  <div style={{
    ...
    overflow: "hidden", opacity: visible ? 1 : 0, transition: "opacity 0.2s ease",
  }}>
    {visible && (
      <div style={{
...
const Spinner = () => (
  <span style={{
    ...
    border: "2.5px solid #BFDBFE", borderTopColor: "#FFFFFF",
    borderRadius: "50%", animation: "spinnerRotate 0.65s linear infinite",
...
const FieldLabel = ({ text, required }) => (
  <label style={{
    ...
    letterSpacing: "0.16em", textTransform: "uppercase", color: "#374151",
    marginBottom: "8px", fontFamily: "'IBM Plex Sans', sans-serif",
  }}>
...
export default function EntryForm({ onClose, onSaved }) {
  ...
  const {
    ...
    defaultValues: {
      date:         localDateStr(), // FIX: local date, not UTC
      labourAmount: "",
      leaveDays:    "",
      hoursWorked:  "",
      vehicleNo:    "",
...
onClose();
  ...
  const inputBase = {
    width: "100%", boxSizing: "border-box", height: "56px", padding: "0 14px",
    background: "#F8FAFC", border: "1.5px solid #CBD5E1", borderRadius: "0",
    color: "#0A1628", fontSize: "18px", fontWeight: "700",
      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            background: "#FFFFFF", borderBottom: "1.5px solid #E2E8F0",
            padding: "14px 20px",
          }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
                <h2 style={{
                  fontFamily: "'Barlow Condensed', sans-serif", fontSize: "22px", fontWeight: "700",
                  color: "#0A1628", letterSpacing: "0.04em", textTransform: "uppercase",
                ...
                <p style={{
                  ...
                  transition: "color 0.2s", fontFamily: "'IBM Plex Sans', sans-serif",
                }}>
              ...
              <button
                ...
                disabled={loading}
                style={{
                  background: "#F8FAFC", border: "1.5px solid #DDE3EE", borderRadius: "0",
                  width: "44px", height: "44px", color: "#374151", fontSize: "22px",
          ...
          <form
            ...
            style={{ display: "flex", flexDirection: "column", gap: "22px", padding: "24px 20px 36px" }}
          >
            {/* ── Date ── */}
            <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
              <div>
                ...
                <input
                  ...
                  style={{ ...inputBase, fontFamily: "'IBM Plex Sans', sans-serif", fontSize: "15px", letterSpacing: "0.04em" }}
              ...
              <div>
                ...
                <input
                  ...
                  style={{ ...inputBase, fontFamily: "'IBM Plex Sans', sans-serif", fontSize: "13px", letterSpacing: "0.06em" }}
                  autoComplete="off"
                  spellCheck={false}
                  maxLength={20}
                  {...register("vehicleNo", {
                ...
                {vehicleNoValue && !errors.vehicleNo && (
                  <p style={{
                    margin: "5px 0 0", fontSize: "10px", fontWeight: "600",
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <div style={{
                  ...
                  justifyContent: "center", color: "#FFFFFF", fontSize: "18px",
                  fontWeight: "700", pointerEvents: "none", userSelect: "none", zIndex: 1,
                }}>₹</div>
                <input
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <div style={{
                  position: "absolute", left: 0, top: 0, bottom: 0, width: "48px",
                  background: "#1E3A8A", display: "flex", alignItems: "center",
                  justifyContent: "center", color: "#FFFFFF", fontSize: "13px",
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <div style={{
                  ...
                  justifyContent: "center", color: "#FFFFFF", fontSize: "11px",
                  fontWeight: "700", letterSpacing: "0.04em",
                  pointerEvents: "none", userSelect: "none", zIndex: 1,
                }}>LVE</div>
                <input
            ...
            {serverError && (
              <div style={{
                ...
                borderLeft: "4px solid #DC2626", padding: "14px 16px",
              }}>
                <p style={{
                  margin: 0, fontSize: "13px", fontWeight: "600",
                  color: "#991B1B", fontFamily: "'IBM Plex Sans', sans-serif",
                }}>{serverError}</p>
              </div>
            )}
            ...
            <button
              ...
              disabled={loading}
              style={{
                width: "100%", height: "60px", background: "#1E3A8A",
                border: "none", borderRadius: "0", color: "#FFFFFF",
                fontSize: "13px", fontWeight: "700", letterSpacing: "0.16em",
                textTransform: "uppercase", cursor: "pointer",
                fontFamily: "'IBM Plex Sans', sans-serif", marginTop: "6px",
                transition: "background 0.15s ease, transform 0.1s ease",
                WebkitTapHighlightColor: "transparent",
                display: "flex", alignItems: "center", justifyContent: "center",
              }}
            >
              {loading ? <><Spinner />Saving Entry…</> : "Save Entry"}
            </button>
          </form>
        </div>
      </div>
